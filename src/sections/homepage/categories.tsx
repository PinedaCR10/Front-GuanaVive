...
const Sun = () => (
  <svg width="20" height="20" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      d="M6.76 4.84l-1.8-1.79L3.17 4.84l1.79 1.79l1.8-1.79m10.48 0l1.79-1.79l1.79 1.79l-1.79 1.79l-1.79-1.79M12 4V1h0v3h0m0 19v-3h0v3h0M4 12H1v0h3v0m22 0h-3v0h3v0M6.76 19.16l-1.8 1.79l-1.79-1.79l1.79-1.79l1.8 1.79m10.48 0l1.79 1.79l1.79-1.79l-1.79-1.79l-1.79 1.79M12 8a4 4 0 1 1 0 8a4 4 0 0 1 0-8Z"
    />
  </svg>
);
const Moon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24">
    <path fill="currentColor" d="M20.742 13.045A8 8 0 0 1 11 3a8 8 0 1 0 9.742 10.045Z" />
  </svg>
);
const Lang = () => (
  <svg width="20" height="20" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      d="M11 7h10v2h-4.08A15 15 0 0 1 20 17h-2a13 13 0 0 0-1.74-5H11V7Zm-1-4h2v2h-2V3ZM3 5h6v2H6.46A17 17 0 0 0 9.4 11h3.1v2H9.98c.44.88.98 1.72 1.62 2.5l-1.56 1.25A14 14 0 0 1 8.2 13H5v-2h2.36A15 15 0 0 1 5.6 7H3V5Z"
    />
  </svg>
);
...
export default function Categories() {
  ...
  // ✅ Imágenes locales desde /public/images/Categories
    ...
    () => [
      {
        ...
        title: "Bailes",
        description:
          "Expresiones de identidad y tradición a través del movimiento.",
        image: "/images/Categories/bailes.jpg",
      },
      {
        slug: "musica",
        title: "Música",
        description:
          "Sonidos que cuentan la historia viva del folclor guanacasteco.",
        image: "/images/Categories/musicos.jpg",
      },
      {
        slug: "retahileros",
        title: "Retahileros",
        description:
          "Narradores populares que preservan nuestras raíces orales.",
        image: "/images/Categories/retahileros.jpg",
      },
      {
        slug: "eventos",
        title: "Eventos",
      ...
      },
      {
        ...
        image: "/images/Categories/artesanos.jpg",
      },
      {
        slug: "haciendas",
        title: "Haciendas",
        description: "Arquitectura y tradición de la pampa.",
        image: "/images/Categories/haciendas.jpg",
      },
    ],
    []
  );
          ...
          {categories.map((cat) => (
            <motion.article
              ...
              className="group rounded-xl border shadow-sm outline-none transition
                         hover:-translate-y-0.5 hover:shadow-md focus:shadow-md
            ...
            >
              <div
                className="w-full overflow-hidden rounded-t-xl relative"
